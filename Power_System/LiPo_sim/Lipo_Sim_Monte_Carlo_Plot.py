...
def LiPo_sim (P_max_mot=320,P_avg_mot=130,t_flight=10):
    ...
    number_of_cycles_to_simulate = 600
    R_eff_initial_cycle_0 = 0.012 # Initial condition for internal resistance
    ...
    P_max = P_max_mot / 0.9 # Assuming that propellers draw 95% of the power 
    ...
    for run in range(Number_Monte_carlo_runs):
        ...
        number_of_equiv_cycles = number_of_cycles * avg_DoD * 3 # Equivalent actual full cycles the battery has gone through
    ...
    # Degradation Model
        ...
        fail_mask_2 = ((C_rate_arr >  max_c_rate) | (V_arr < 2.75 * 4))
