...
if __name__ == '__main__':
    ...
    # ── Configuration ─────────────────────────────────────────────────────────
    DISCHARGE_CURRENT = 18.0     # [A]  – must match the dataset
    CAPACITY_Ah       = 0.32     # [Ah] – 1000 mAh
    ...
    # ── Load measured data ────────────────────────────────────────────────────
    PATH = r"C:\Users\spash\OneDrive\Desktop\Uni\Bachelor\Year 3\DSE\DSE Code\DSE-09-Drone-Platform-for-Automated-Pest-Control\Power_System\CSV files\2_0_stressdischarge.csv"
    ...
    metrics = compute_metrics(t_meas, V_meas, t_sim, V_sim)
    print("─" * 42)
