...
P_peak = cp.P_peak_ClassII #W
P_avg = cp.avg_to_peak_ratio * P_peak # W

#battery and capcitor params

P_density_Li_ion = cp.P_density_li_ion_classII #W/kg #3024 for 60-80gram
E_density_Li_ion = cp.E_density_li_ion_classII # Wh/kg # 245 for 60-80gram

P_density_supercap = cp.P_density_supercap_classII # W/kg
E_density_supercap = cp.E_density_supercap_classII # Wh/kg
...
m_energy_req_list = E_total / ( battery_ratio_list * E_density_Li_ion + (1-battery_ratio_list)*E_density_supercap)
m_maxpower_req_list = P_peak / (battery_ratio_list * P_density_Li_ion + (1- battery_ratio_list) *P_density_supercap)
